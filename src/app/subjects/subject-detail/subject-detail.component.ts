...
@Component({
    standalone: true,
    imports: [ItemTableComponent, AddStudentComponent, AddSubjectComponent, ProfileLayoutComponent, ProfilePhotoComponent, ProfileInfoComponent, TitleCasePipe, DatePipe, RouterLink],
